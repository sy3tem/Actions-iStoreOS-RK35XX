...
\$(call Device/Legacy/rk3568,\$(1))
  ...
  DEVICE_PACKAGES += kmod-nvme kmod-ata-ahci-dwc kmod-hwmon-pwmfan kmod-thermal kmod-dsa-realtek kmod-dsa-tag-rtl4-a kmod-r8169 kmod-mt7916-firmware
endef
...
\$(call Device/Legacy/rk3568,\$(1))
  ...
  DEVICE_PACKAGES += kmod-nvme kmod-ata-ahci-dwc kmod-hwmon-pwmfan kmod-thermal kmod-dsa-realtek kmod-dsa-tag-rtl4-a kmod-r8169 kmod-mt7615-firmware
endef
...
mkdir -p target/linux/rockchip/files/drivers/net/phy
cp -f $GITHUB_WORKSPACE/configfiles/rtl8365mb.c target/linux/rockchip/files/drivers/net/phy/rtl8365mb.c
